    ...
    <div class="card card-purple">
        ...
        <div class="card-body">
            <div class="container-fluid">
                <div class="btn-group">
                    <button wire:click="guardar_hora_inicio" class="btn btn-primary col-lg-8 col-6" data-bs-toggle="button" {{$enable_inicio}}><i class="fas fa-hourglass-start"></i> Inicio <br> Actividad</button>
                    <button wire:click="guardar_hora_fin"    class="btn btn-danger  col-lg-8 col-6" style="margin-left:5px; " data-bs-toggle="button" {{$enable_fin}}><i class="fas fa-hourglass-end"></i> Fin <br> Actividad</button>
                </div>
                <div class="btn-group">
